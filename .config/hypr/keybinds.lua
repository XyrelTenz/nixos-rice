...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("bash -c 'if command -v wl-copy &>/dev/null; then grim -g \"$(slurp)\" - | wl-copy; else nix-shell -p wl-clipboard --run \"grim -g \\\"$(slurp)\\\" - | wl-copy\"; fi'"))
