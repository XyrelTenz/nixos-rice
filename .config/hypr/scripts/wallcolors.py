...
def main():
    ...
    acc = pill["primary"]          # accent (was base08)
    dim = b["base03"]              # muted foreground
    bg  = b["base00"]              # background
    fg  = b["base07"]              # foreground
    bg2 = b["base02"]              # surface / message bg
    border = b["base01"]           # pane border
    tmux_lines = [
        "# Auto-generated by wallcolors.py — do not edit by hand.",
        "set -g status-position top",
        f'set -g status-style "bg=default,fg={fg}"',
        f'set -g status-left "#[fg={bg},bg={acc},bold] #S #[bg=default,fg={acc}]"',
        "set -g status-left-length 20",
        f'set -g window-status-current-style "fg={acc},bold"',
        'set -g window-status-current-format " #I:#W "',
        f'set -g window-status-style "fg={dim}"',
        'set -g window-status-format " #I:#W "',
        f'set -g status-right "#[fg={acc}]#[fg={bg},bg={acc},bold] %H:%M #[fg={fg},bg={dim}] %d-%b-%y "',
